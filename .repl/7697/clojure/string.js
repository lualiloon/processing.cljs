...
{{
var G__20494 = cljs.core.pop.call(null,v__$1);
v__$1 = G__20494;
continue;
}
} else
...
{var pred__20498 = cljs.core._EQ_;var expr__20499 = limit;if(cljs.core.truth_(pred__20498.call(null,1,expr__20499)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__20498.call(null,2,expr__20499)))
...
var G__20501 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__20502 = (limit__$1 - 1);
var G__20503 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__20501;
limit__$1 = G__20502;
parts = G__20503;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___20505 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___20505))
{var replacement_20506 = temp__4090__auto___20505;buffer.append([cljs.core.str(replacement_20506)].join(''));
} else
{buffer.append(ch);
}
{
var G__20507 = (index + 1);
index = G__20507;
continue;
}
}

...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t23112 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t23112 = (function (val,box,meta23113){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t23112.cljs$lang$type = true;
cljs.core.async.impl.channels.t23112.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t23112";
cljs.core.async.impl.channels.t23112.cljs$lang$ctorPrWriter = (function (this__8412__auto__,writer__8413__auto__,opt__8414__auto__){return cljs.core._write.call(null,writer__8413__auto__,"cljs.core.async.impl.channels/t23112");
});
cljs.core.async.impl.channels.t23112.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t23112.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_23114){var self__ = this;
var _23114__$1 = this;return self__.meta23113;
});
cljs.core.async.impl.channels.t23112.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_23114,meta23113__$1){var self__ = this;
var _23114__$1 = this;return (new cljs.core.async.impl.channels.t23112(self__.val,self__.box,meta23113__$1));
});
cljs.core.async.impl.channels.__GT_t23112 = (function __GT_t23112(val__$1,box__$1,meta23113){return (new cljs.core.async.impl.channels.t23112(val__$1,box__$1,meta23113));
});
}
return (new cljs.core.async.impl.channels.t23112(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__8415__auto__,writer__8416__auto__,opts__8417__auto__){return cljs.core._write.call(null,writer__8416__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__8412__auto__,writer__8413__auto__,opt__8414__auto__){return cljs.core._write.call(null,writer__8413__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_23115 = self__.takes.pop();if((taker_23115 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_23115))
{var take_cb_23116 = cljs.core.async.impl.protocols.commit.call(null,taker_23115);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_23116,taker_23115){
return (function (){return take_cb_23116.call(null,null);
});})(take_cb_23116,taker_23115))
);
} else
{}
{

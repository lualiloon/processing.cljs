...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_23071 = 0;while(true){
if((i_23071 < arr.length))
{(arr[i_23071] = null);
{
...
{var i_23078 = (self__.level + 1);while(true){
if((i_23078 <= (new_level + 1)))
{(update[i_23078] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_23080 = 0;while(true){
if((i_23080 <= self__.level))
{var links_23081 = (update[i_23080]).forward;if(((links_23081[i_23080]) === x__$1))
{(links_23081[i_23080] = (x__$1.forward[i_23080]));
{

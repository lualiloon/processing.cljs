...
sablono.util.ToString = (function (){var obj21741 = {};return obj21741;
})();
sablono.util.to_str = (function to_str(x){if((function (){var and__7850__auto__ = x;if(and__7850__auto__)
...
{var x__8483__auto__ = (((x == null))?null:x);return (function (){var or__7862__auto__ = (sablono.util.to_str[goog.typeOf(x__8483__auto__)]);if(or__7862__auto__)
{return or__7862__auto__;
} else
{var or__7862__auto____$1 = (sablono.util.to_str["_"]);if(or__7862__auto____$1)
...
sablono.util.ToURI = (function (){var obj21743 = {};return obj21743;
})();
sablono.util.to_uri = (function to_uri(x){if((function (){var and__7850__auto__ = x;if(and__7850__auto__)
...
{var x__8483__auto__ = (((x == null))?null:x);return (function (){var or__7862__auto__ = (sablono.util.to_uri[goog.typeOf(x__8483__auto__)]);if(or__7862__auto__)
{return or__7862__auto__;
} else
{var or__7862__auto____$1 = (sablono.util.to_uri["_"]);if(or__7862__auto____$1)
{return or__7862__auto____$1;
} else
...
as_str.cljs$lang$applyTo = (function (arglist__21744){
var xs = cljs.core.seq(arglist__21744);
...
{var vec__21746 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__21746,0,null);var words = cljs.core.nthnext.call(null,vec__21746,1);if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__21747_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__21747_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__21747_SHARP_], null);
} else
{if(cljs.core.vector_QMARK_.call(null,p1__21747_SHARP_))
{return p1__21747_SHARP_;
} else
...
merge_with_class.cljs$lang$applyTo = (function (arglist__21748){
var maps = cljs.core.seq(arglist__21748);
...
*/
sablono.util.normalize_element = (function normalize_element(p__21749){var vec__21752 = p__21749;var tag = cljs.core.nth.call(null,vec__21752,0,null);var content = cljs.core.nthnext.call(null,vec__21752,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__21753 = cljs.core.re_matches.call(null,sablono.util.re_tag,cljs.core.name.call(null,tag));var _ = cljs.core.nth.call(null,vec__21753,0,null);var tag__$1 = cljs.core.nth.call(null,vec__21753,1,null);var id = cljs.core.nth.call(null,vec__21753,2,null);var class$ = cljs.core.nth.call(null,vec__21753,3,null);var tag_attrs = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",1013907597),id,new cljs.core.Keyword(null,"class","class",1108647146),(cljs.core.truth_(class$)?clojure.string.split.call(null,class$,/\./):null)], null);var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
...
goog.Uri.prototype.sablono$util$ToString$to_str$arity$1 = (function (x){var x__$1 = this;if(cljs.core.truth_((function (){var or__7862__auto__ = x__$1.hasDomain();if(cljs.core.truth_(or__7862__auto__))
{return or__7862__auto__;
} else

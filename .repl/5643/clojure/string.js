...
{{
var G__21788 = cljs.core.pop.call(null,v__$1);
v__$1 = G__21788;
continue;
}
} else
...
{var pred__21792 = cljs.core._EQ_;var expr__21793 = limit;if(cljs.core.truth_(pred__21792.call(null,1,expr__21793)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__21792.call(null,2,expr__21793)))
...
{var ch = s.charAt(index);var temp__4090__auto___21799 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___21799))
{var replacement_21800 = temp__4090__auto___21799;buffer.append([cljs.core.str(replacement_21800)].join(''));
} else
{buffer.append(ch);
}
{
var G__21801 = (index + 1);
index = G__21801;
continue;
}
}

...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_24419 = 0;while(true){
if((i_24419 < arr.length))
{(arr[i_24419] = null);
{
var G__24420 = (i_24419 + 1);
i_24419 = G__24420;
continue;
}
} else
...
{var i_24426 = (self__.level + 1);while(true){
if((i_24426 <= (new_level + 1)))
{(update[i_24426] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_24428 = 0;while(true){
if((i_24428 <= self__.level))
{var links_24429 = (update[i_24428]).forward;if(((links_24429[i_24428]) === x__$1))
{(links_24429[i_24428] = (x__$1.forward[i_24428]));
{
var G__24430 = (i_24428 + 1);
i_24428 = G__24430;
continue;
}
} else
{{
var G__24431 = (i_24428 + 1);
i_24428 = G__24431;
continue;
}
}

...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t24460 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t24460 = (function (val,box,meta24461){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t24460.cljs$lang$type = true;
cljs.core.async.impl.channels.t24460.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t24460";
cljs.core.async.impl.channels.t24460.cljs$lang$ctorPrWriter = (function (this__8424__auto__,writer__8425__auto__,opt__8426__auto__){return cljs.core._write.call(null,writer__8425__auto__,"cljs.core.async.impl.channels/t24460");
});
cljs.core.async.impl.channels.t24460.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t24460.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_24462){var self__ = this;
var _24462__$1 = this;return self__.meta24461;
});
cljs.core.async.impl.channels.t24460.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_24462,meta24461__$1){var self__ = this;
var _24462__$1 = this;return (new cljs.core.async.impl.channels.t24460(self__.val,self__.box,meta24461__$1));
});
cljs.core.async.impl.channels.__GT_t24460 = (function __GT_t24460(val__$1,box__$1,meta24461){return (new cljs.core.async.impl.channels.t24460(val__$1,box__$1,meta24461));
});
}
return (new cljs.core.async.impl.channels.t24460(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_24463 = self__.takes.pop();if((taker_24463 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_24463))
{var take_cb_24464 = cljs.core.async.impl.protocols.commit.call(null,taker_24463);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_24464,taker_24463){
return (function (){return take_cb_24464.call(null,null);
});})(take_cb_24464,taker_24463))
);
} else
{}
{

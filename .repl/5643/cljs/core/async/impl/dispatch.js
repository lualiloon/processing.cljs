...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_24454 = 0;while(true){
var m_24455 = cljs.core.async.impl.dispatch.tasks.pop();if((m_24455 == null))
{} else
{m_24455.call(null);
if((count_24454 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__24456 = (count_24454 + 1);
count_24454 = G__24456;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__7850__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__7850__auto__)

...
{{
var G__48118 = cljs.core.pop.call(null,v__$1);
v__$1 = G__48118;
continue;
}
} else
...
{var pred__48122 = cljs.core._EQ_;var expr__48123 = limit;if(cljs.core.truth_(pred__48122.call(null,1,expr__48123)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__48122.call(null,2,expr__48123)))
...
var G__48125 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__48126 = (limit__$1 - 1);
var G__48127 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__48125;
limit__$1 = G__48126;
parts = G__48127;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___48129 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___48129))
{var replacement_48130 = temp__4090__auto___48129;buffer.append([cljs.core.str(replacement_48130)].join(''));
} else
{buffer.append(ch);
}
{
var G__48131 = (index + 1);
index = G__48131;
continue;
}
}

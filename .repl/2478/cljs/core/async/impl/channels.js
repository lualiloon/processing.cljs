...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t50736 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t50736 = (function (val,box,meta50737){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t50736.cljs$lang$type = true;
cljs.core.async.impl.channels.t50736.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t50736";
cljs.core.async.impl.channels.t50736.cljs$lang$ctorPrWriter = (function (this__8412__auto__,writer__8413__auto__,opt__8414__auto__){return cljs.core._write.call(null,writer__8413__auto__,"cljs.core.async.impl.channels/t50736");
});
cljs.core.async.impl.channels.t50736.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t50736.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_50738){var self__ = this;
var _50738__$1 = this;return self__.meta50737;
});
cljs.core.async.impl.channels.t50736.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_50738,meta50737__$1){var self__ = this;
var _50738__$1 = this;return (new cljs.core.async.impl.channels.t50736(self__.val,self__.box,meta50737__$1));
});
cljs.core.async.impl.channels.__GT_t50736 = (function __GT_t50736(val__$1,box__$1,meta50737){return (new cljs.core.async.impl.channels.t50736(val__$1,box__$1,meta50737));
});
}
return (new cljs.core.async.impl.channels.t50736(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_50739 = self__.takes.pop();if((taker_50739 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_50739))
{var take_cb_50740 = cljs.core.async.impl.protocols.commit.call(null,taker_50739);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_50740,taker_50739){
return (function (){return take_cb_50740.call(null,null);
});})(take_cb_50740,taker_50739))
);
} else
{}
{

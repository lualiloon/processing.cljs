...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__8412__auto__,writer__8413__auto__,opt__8414__auto__){return cljs.core._write.call(null,writer__8413__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_50695 = 0;while(true){
if((i_50695 < arr.length))
{(arr[i_50695] = null);
{
var G__50696 = (i_50695 + 1);
i_50695 = G__50696;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__8412__auto__,writer__8413__auto__,opt__8414__auto__){return cljs.core._write.call(null,writer__8413__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_50702 = (self__.level + 1);while(true){
if((i_50702 <= (new_level + 1)))
{(update[i_50702] = self__.header);
{
var G__50703 = (i_50702 + 1);
i_50702 = G__50703;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_50704 = 0;while(true){
if((i_50704 <= self__.level))
{var links_50705 = (update[i_50704]).forward;if(((links_50705[i_50704]) === x__$1))
{(links_50705[i_50704] = (x__$1.forward[i_50704]));
{
var G__50706 = (i_50704 + 1);
i_50704 = G__50706;
continue;
}
} else
{{
var G__50707 = (i_50704 + 1);
i_50704 = G__50707;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__7850__auto__ = (cljs.core.truth_((function (){var and__7838__auto__ = me;if(cljs.core.truth_(and__7838__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__7838__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__7850__auto__))

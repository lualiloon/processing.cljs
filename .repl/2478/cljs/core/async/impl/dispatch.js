...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_50730 = 0;while(true){
var m_50731 = cljs.core.async.impl.dispatch.tasks.pop();if((m_50731 == null))
{} else
{m_50731.call(null);
if((count_50730 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__50732 = (count_50730 + 1);
count_50730 = G__50732;
continue;
}
} else
{}

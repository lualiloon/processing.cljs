...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__8424__auto__,writer__8425__auto__,opt__8426__auto__){return cljs.core._write.call(null,writer__8425__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_51669 = 0;while(true){
if((i_51669 < arr.length))
{(arr[i_51669] = null);
{
var G__51670 = (i_51669 + 1);
i_51669 = G__51670;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__8424__auto__,writer__8425__auto__,opt__8426__auto__){return cljs.core._write.call(null,writer__8425__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_51676 = (self__.level + 1);while(true){
if((i_51676 <= (new_level + 1)))
{(update[i_51676] = self__.header);
{
var G__51677 = (i_51676 + 1);
i_51676 = G__51677;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_51678 = 0;while(true){
if((i_51678 <= self__.level))
{var links_51679 = (update[i_51678]).forward;if(((links_51679[i_51678]) === x__$1))
{(links_51679[i_51678] = (x__$1.forward[i_51678]));
{
var G__51680 = (i_51678 + 1);
i_51678 = G__51680;
continue;
}
} else
{{
var G__51681 = (i_51678 + 1);
i_51678 = G__51681;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__7862__auto__ = (cljs.core.truth_((function (){var and__7850__auto__ = me;if(cljs.core.truth_(and__7850__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__7850__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__7862__auto__))

...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_51692 = 0;while(true){
var m_51693 = cljs.core.async.impl.dispatch.tasks.pop();if((m_51693 == null))
{} else
{m_51693.call(null);
if((count_51692 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__51694 = (count_51692 + 1);
count_51692 = G__51694;
continue;
}
} else
{}

...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t51698 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t51698 = (function (val,box,meta51699){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t51698.cljs$lang$type = true;
cljs.core.async.impl.channels.t51698.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t51698";
cljs.core.async.impl.channels.t51698.cljs$lang$ctorPrWriter = (function (this__8424__auto__,writer__8425__auto__,opt__8426__auto__){return cljs.core._write.call(null,writer__8425__auto__,"cljs.core.async.impl.channels/t51698");
});
cljs.core.async.impl.channels.t51698.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t51698.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_51700){var self__ = this;
var _51700__$1 = this;return self__.meta51699;
});
cljs.core.async.impl.channels.t51698.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_51700,meta51699__$1){var self__ = this;
var _51700__$1 = this;return (new cljs.core.async.impl.channels.t51698(self__.val,self__.box,meta51699__$1));
});
cljs.core.async.impl.channels.__GT_t51698 = (function __GT_t51698(val__$1,box__$1,meta51699){return (new cljs.core.async.impl.channels.t51698(val__$1,box__$1,meta51699));
});
}
return (new cljs.core.async.impl.channels.t51698(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_51701 = self__.takes.pop();if((taker_51701 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_51701))
{var take_cb_51702 = cljs.core.async.impl.protocols.commit.call(null,taker_51701);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_51702,taker_51701){
return (function (){return take_cb_51702.call(null,null);
});})(take_cb_51702,taker_51701))
);
} else
{}
{

...
{{
var G__49092 = cljs.core.pop.call(null,v__$1);
v__$1 = G__49092;
continue;
}
} else
...
{var pred__49096 = cljs.core._EQ_;var expr__49097 = limit;if(cljs.core.truth_(pred__49096.call(null,1,expr__49097)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__49096.call(null,2,expr__49097)))
...
var G__49099 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__49100 = (limit__$1 - 1);
var G__49101 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__49099;
limit__$1 = G__49100;
parts = G__49101;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___49103 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___49103))
{var replacement_49104 = temp__4090__auto___49103;buffer.append([cljs.core.str(replacement_49104)].join(''));
} else
{buffer.append(ch);
}
{
var G__49105 = (index + 1);
index = G__49105;
continue;
}
}

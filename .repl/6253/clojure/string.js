...
{{
var G__62549 = cljs.core.pop.call(null,v__$1);
v__$1 = G__62549;
continue;
}
} else
...
{var pred__62553 = cljs.core._EQ_;var expr__62554 = limit;if(cljs.core.truth_(pred__62553.call(null,1,expr__62554)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__62553.call(null,2,expr__62554)))
...
var G__62556 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__62557 = (limit__$1 - 1);
var G__62558 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__62556;
limit__$1 = G__62557;
parts = G__62558;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___62560 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___62560))
{var replacement_62561 = temp__4090__auto___62560;buffer.append([cljs.core.str(replacement_62561)].join(''));
} else
{buffer.append(ch);
}
{
var G__62562 = (index + 1);
index = G__62562;
continue;
}
}

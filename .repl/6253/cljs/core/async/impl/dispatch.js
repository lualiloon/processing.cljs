...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_65161 = 0;while(true){
var m_65162 = cljs.core.async.impl.dispatch.tasks.pop();if((m_65162 == null))
{} else
{m_65162.call(null);
if((count_65161 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__65163 = (count_65161 + 1);
count_65161 = G__65163;
continue;
}
} else
{}

...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t65167 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t65167 = (function (val,box,meta65168){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t65167.cljs$lang$type = true;
cljs.core.async.impl.channels.t65167.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t65167";
cljs.core.async.impl.channels.t65167.cljs$lang$ctorPrWriter = (function (this__8424__auto__,writer__8425__auto__,opt__8426__auto__){return cljs.core._write.call(null,writer__8425__auto__,"cljs.core.async.impl.channels/t65167");
});
cljs.core.async.impl.channels.t65167.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t65167.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_65169){var self__ = this;
var _65169__$1 = this;return self__.meta65168;
});
cljs.core.async.impl.channels.t65167.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_65169,meta65168__$1){var self__ = this;
var _65169__$1 = this;return (new cljs.core.async.impl.channels.t65167(self__.val,self__.box,meta65168__$1));
});
cljs.core.async.impl.channels.__GT_t65167 = (function __GT_t65167(val__$1,box__$1,meta65168){return (new cljs.core.async.impl.channels.t65167(val__$1,box__$1,meta65168));
});
}
return (new cljs.core.async.impl.channels.t65167(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__8427__auto__,writer__8428__auto__,opts__8429__auto__){return cljs.core._write.call(null,writer__8428__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__8424__auto__,writer__8425__auto__,opt__8426__auto__){return cljs.core._write.call(null,writer__8425__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_65170 = self__.takes.pop();if((taker_65170 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_65170))
{var take_cb_65171 = cljs.core.async.impl.protocols.commit.call(null,taker_65170);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_65171,taker_65170){
return (function (){return take_cb_65171.call(null,null);
});})(take_cb_65171,taker_65170))
);
} else
{}
{

...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_65126 = 0;while(true){
if((i_65126 < arr.length))
{(arr[i_65126] = null);
{
...
{var i_65133 = (self__.level + 1);while(true){
if((i_65133 <= (new_level + 1)))
{(update[i_65133] = self__.header);
{
var G__65134 = (i_65133 + 1);
i_65133 = G__65134;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_65135 = 0;while(true){
if((i_65135 <= self__.level))
{var links_65136 = (update[i_65135]).forward;if(((links_65136[i_65135]) === x__$1))
{(links_65136[i_65135] = (x__$1.forward[i_65135]));
{
var G__65137 = (i_65135 + 1);
i_65135 = G__65137;
continue;
}
} else
{{
var G__65138 = (i_65135 + 1);
i_65135 = G__65138;
continue;
}
}

...
sablono.util.ToString = (function (){var obj62502 = {};return obj62502;
})();
...
sablono.util.ToURI = (function (){var obj62504 = {};return obj62504;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__62505){
var xs = cljs.core.seq(arglist__62505);
...
{var vec__62507 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__62507,0,null);var words = cljs.core.nthnext.call(null,vec__62507,1);if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__62508_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__62508_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__62508_SHARP_], null);
} else
{if(cljs.core.vector_QMARK_.call(null,p1__62508_SHARP_))
{return p1__62508_SHARP_;
} else
...
merge_with_class.cljs$lang$applyTo = (function (arglist__62509){
var maps = cljs.core.seq(arglist__62509);
...
*/
sablono.util.normalize_element = (function normalize_element(p__62510){var vec__62513 = p__62510;var tag = cljs.core.nth.call(null,vec__62513,0,null);var content = cljs.core.nthnext.call(null,vec__62513,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))

...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t30249 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t30249 = (function (val,box,meta30250){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t30249.cljs$lang$type = true;
cljs.core.async.impl.channels.t30249.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t30249";
cljs.core.async.impl.channels.t30249.cljs$lang$ctorPrWriter = (function (this__8412__auto__,writer__8413__auto__,opt__8414__auto__){return cljs.core._write.call(null,writer__8413__auto__,"cljs.core.async.impl.channels/t30249");
});
cljs.core.async.impl.channels.t30249.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t30249.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_30251){var self__ = this;
var _30251__$1 = this;return self__.meta30250;
});
cljs.core.async.impl.channels.t30249.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_30251,meta30250__$1){var self__ = this;
var _30251__$1 = this;return (new cljs.core.async.impl.channels.t30249(self__.val,self__.box,meta30250__$1));
});
cljs.core.async.impl.channels.__GT_t30249 = (function __GT_t30249(val__$1,box__$1,meta30250){return (new cljs.core.async.impl.channels.t30249(val__$1,box__$1,meta30250));
});
}
return (new cljs.core.async.impl.channels.t30249(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_30252 = self__.takes.pop();if((taker_30252 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_30252))
{var take_cb_30253 = cljs.core.async.impl.protocols.commit.call(null,taker_30252);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_30253,taker_30252){
return (function (){return take_cb_30253.call(null,null);
});})(take_cb_30253,taker_30252))
);
} else
{}
{

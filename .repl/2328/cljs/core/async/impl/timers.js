...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_30208 = 0;while(true){
if((i_30208 < arr.length))
{(arr[i_30208] = null);
{
...
{var i_30215 = (self__.level + 1);while(true){
if((i_30215 <= (new_level + 1)))
{(update[i_30215] = self__.header);
{
var G__30216 = (i_30215 + 1);
i_30215 = G__30216;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_30217 = 0;while(true){
if((i_30217 <= self__.level))
{var links_30218 = (update[i_30217]).forward;if(((links_30218[i_30217]) === x__$1))
{(links_30218[i_30217] = (x__$1.forward[i_30217]));
{
var G__30219 = (i_30217 + 1);
i_30217 = G__30219;
continue;
}
} else
{{
var G__30220 = (i_30217 + 1);
i_30217 = G__30220;
continue;
}
}

...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_30243 = 0;while(true){
var m_30244 = cljs.core.async.impl.dispatch.tasks.pop();if((m_30244 == null))
{} else
{m_30244.call(null);
if((count_30243 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__30245 = (count_30243 + 1);
count_30243 = G__30245;
continue;
}
} else
{}

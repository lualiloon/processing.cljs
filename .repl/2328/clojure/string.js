...
{{
var G__27631 = cljs.core.pop.call(null,v__$1);
v__$1 = G__27631;
continue;
}
} else
...
{var pred__27635 = cljs.core._EQ_;var expr__27636 = limit;if(cljs.core.truth_(pred__27635.call(null,1,expr__27636)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__27635.call(null,2,expr__27636)))
...
var G__27638 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__27639 = (limit__$1 - 1);
var G__27640 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__27638;
limit__$1 = G__27639;
parts = G__27640;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___27642 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___27642))
{var replacement_27643 = temp__4090__auto___27642;buffer.append([cljs.core.str(replacement_27643)].join(''));
} else
{buffer.append(ch);
}
{
var G__27644 = (index + 1);
index = G__27644;
continue;
}
}

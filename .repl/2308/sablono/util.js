...
sablono.util.ToString = (function (){var obj34779 = {};return obj34779;
})();
...
sablono.util.ToURI = (function (){var obj34781 = {};return obj34781;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__34782){
var xs = cljs.core.seq(arglist__34782);
...
{var vec__34784 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__34784,0,null);var words = cljs.core.nthnext.call(null,vec__34784,1);if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__34785_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__34785_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__34785_SHARP_], null);
} else
{if(cljs.core.vector_QMARK_.call(null,p1__34785_SHARP_))
...
merge_with_class.cljs$lang$applyTo = (function (arglist__34786){
var maps = cljs.core.seq(arglist__34786);
...
*/
sablono.util.normalize_element = (function normalize_element(p__34787){var vec__34790 = p__34787;var tag = cljs.core.nth.call(null,vec__34790,0,null);var content = cljs.core.nthnext.call(null,vec__34790,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__34791 = cljs.core.re_matches.call(null,sablono.util.re_tag,cljs.core.name.call(null,tag));var _ = cljs.core.nth.call(null,vec__34791,0,null);var tag__$1 = cljs.core.nth.call(null,vec__34791,1,null);var id = cljs.core.nth.call(null,vec__34791,2,null);var class$ = cljs.core.nth.call(null,vec__34791,3,null);var tag_attrs = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",1013907597),id,new cljs.core.Keyword(null,"class","class",1108647146),(cljs.core.truth_(class$)?clojure.string.split.call(null,class$,/\./):null)], null);var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))

...
{{
var G__34826 = cljs.core.pop.call(null,v__$1);
v__$1 = G__34826;
continue;
}
} else
...
{var pred__34830 = cljs.core._EQ_;var expr__34831 = limit;if(cljs.core.truth_(pred__34830.call(null,1,expr__34831)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__34830.call(null,2,expr__34831)))
...
var G__34833 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__34834 = (limit__$1 - 1);
var G__34835 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__34833;
limit__$1 = G__34834;
parts = G__34835;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___34837 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___34837))
{var replacement_34838 = temp__4090__auto___34837;buffer.append([cljs.core.str(replacement_34838)].join(''));
} else
{buffer.append(ch);
}
{
var G__34839 = (index + 1);
index = G__34839;
continue;
}
}

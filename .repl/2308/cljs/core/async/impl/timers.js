...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_37403 = 0;while(true){
if((i_37403 < arr.length))
{(arr[i_37403] = null);
{
...
{var i_37410 = (self__.level + 1);while(true){
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_37412 = 0;while(true){
if((i_37412 <= self__.level))
{var links_37413 = (update[i_37412]).forward;if(((links_37413[i_37412]) === x__$1))
{(links_37413[i_37412] = (x__$1.forward[i_37412]));
{
var G__37414 = (i_37412 + 1);
i_37412 = G__37414;
continue;
}
} else
{{
var G__37415 = (i_37412 + 1);
i_37412 = G__37415;
continue;
}
}

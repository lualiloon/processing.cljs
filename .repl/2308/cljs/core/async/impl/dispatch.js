...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_37426 = 0;while(true){
var m_37427 = cljs.core.async.impl.dispatch.tasks.pop();if((m_37427 == null))
{} else
{m_37427.call(null);
if((count_37426 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__37428 = (count_37426 + 1);
count_37426 = G__37428;
continue;
}
} else
{}

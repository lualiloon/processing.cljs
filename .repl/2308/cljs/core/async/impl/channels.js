...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t37432 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t37432 = (function (val,box,meta37433){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t37432.cljs$lang$type = true;
cljs.core.async.impl.channels.t37432.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t37432";
cljs.core.async.impl.channels.t37432.cljs$lang$ctorPrWriter = (function (this__8424__auto__,writer__8425__auto__,opt__8426__auto__){return cljs.core._write.call(null,writer__8425__auto__,"cljs.core.async.impl.channels/t37432");
});
cljs.core.async.impl.channels.t37432.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t37432.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_37434){var self__ = this;
var _37434__$1 = this;return self__.meta37433;
});
cljs.core.async.impl.channels.t37432.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_37434,meta37433__$1){var self__ = this;
var _37434__$1 = this;return (new cljs.core.async.impl.channels.t37432(self__.val,self__.box,meta37433__$1));
});
cljs.core.async.impl.channels.__GT_t37432 = (function __GT_t37432(val__$1,box__$1,meta37433){return (new cljs.core.async.impl.channels.t37432(val__$1,box__$1,meta37433));
});
}
return (new cljs.core.async.impl.channels.t37432(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_37435 = self__.takes.pop();if((taker_37435 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_37435))
{var take_cb_37436 = cljs.core.async.impl.protocols.commit.call(null,taker_37435);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_37436,taker_37435){
return (function (){return take_cb_37436.call(null,null);
});})(take_cb_37436,taker_37435))
);
} else
{}
{

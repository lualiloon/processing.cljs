...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__11420__auto__,writer__11421__auto__,opt__11422__auto__){return cljs.core._write.call(null,writer__11421__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_194146 = 0;while(true){
if((i_194146 < arr.length))
{(arr[i_194146] = null);
{
var G__194147 = (i_194146 + 1);
i_194146 = G__194147;
continue;
}
} else
...
var G__194149 = x__$1;
var G__194150 = k;
var G__194151 = (level - 1);
var G__194152 = update;
x = G__194149;
k = G__194150;
level = G__194151;
update = G__194152;
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__11420__auto__,writer__11421__auto__,opt__11422__auto__){return cljs.core._write.call(null,writer__11421__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_194153 = (self__.level + 1);while(true){
if((i_194153 <= (new_level + 1)))
{(update[i_194153] = self__.header);
{
var G__194154 = (i_194153 + 1);
i_194153 = G__194154;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_194155 = 0;while(true){
if((i_194155 <= self__.level))
{var links_194156 = (update[i_194155]).forward;if(((links_194156[i_194155]) === x__$1))
{(links_194156[i_194155] = (x__$1.forward[i_194155]));
{
var G__194157 = (i_194155 + 1);
i_194155 = G__194157;
continue;
}
} else
{{
var G__194158 = (i_194155 + 1);
i_194155 = G__194158;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__10858__auto__ = (cljs.core.truth_((function (){var and__10846__auto__ = me;if(cljs.core.truth_(and__10846__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__10846__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__10858__auto__))

...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t194187 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t194187 = (function (val,box,meta194188){
this.val = val;
this.box = box;
this.meta194188 = meta194188;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t194187.cljs$lang$type = true;
cljs.core.async.impl.channels.t194187.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t194187";
cljs.core.async.impl.channels.t194187.cljs$lang$ctorPrWriter = (function (this__11420__auto__,writer__11421__auto__,opt__11422__auto__){return cljs.core._write.call(null,writer__11421__auto__,"cljs.core.async.impl.channels/t194187");
});
cljs.core.async.impl.channels.t194187.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t194187.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_194189){var self__ = this;
var _194189__$1 = this;return self__.meta194188;
});
cljs.core.async.impl.channels.t194187.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_194189,meta194188__$1){var self__ = this;
var _194189__$1 = this;return (new cljs.core.async.impl.channels.t194187(self__.val,self__.box,meta194188__$1));
});
cljs.core.async.impl.channels.__GT_t194187 = (function __GT_t194187(val__$1,box__$1,meta194188){return (new cljs.core.async.impl.channels.t194187(val__$1,box__$1,meta194188));
});
}
return (new cljs.core.async.impl.channels.t194187(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__11423__auto__,writer__11424__auto__,opts__11425__auto__){return cljs.core._write.call(null,writer__11424__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__11420__auto__,writer__11421__auto__,opt__11422__auto__){return cljs.core._write.call(null,writer__11421__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_194190 = self__.takes.pop();if((taker_194190 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_194190))
{var take_cb_194191 = cljs.core.async.impl.protocols.commit.call(null,taker_194190);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_194191,taker_194190){
return (function (){return take_cb_194191.call(null,null);
});})(take_cb_194191,taker_194190))
);
} else
{}
{

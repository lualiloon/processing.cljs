...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_194181 = 0;while(true){
var m_194182 = cljs.core.async.impl.dispatch.tasks.pop();if((m_194182 == null))
{} else
{m_194182.call(null);
if((count_194181 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__194183 = (count_194181 + 1);
count_194181 = G__194183;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__10846__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__10846__auto__)

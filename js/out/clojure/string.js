...
{{
var G__185043 = cljs.core.pop.call(null,v__$1);
v__$1 = G__185043;
continue;
}
} else
...
{var pred__185047 = cljs.core._EQ_;var expr__185048 = limit;if(cljs.core.truth_(pred__185047.call(null,1,expr__185048)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__185047.call(null,2,expr__185048)))
...
var G__185050 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__185051 = (limit__$1 - 1);
var G__185052 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__185050;
limit__$1 = G__185051;
parts = G__185052;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___185054 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___185054))
{var replacement_185055 = temp__4090__auto___185054;buffer.append([cljs.core.str(replacement_185055)].join(''));
} else
{buffer.append(ch);
}
{
var G__185056 = (index + 1);
index = G__185056;
continue;
}
}
